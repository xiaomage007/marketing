...
import com.charlie.infrastructure.persistent.dao.IUserCreditAccountDao;
import com.charlie.infrastructure.persistent.dao.IUserCreditOrderDao;
...
public class CreditRepository implements ICreditRepository {
    ...
    public void saveUserCreditTradeOrder(TradeAggregate tradeAggregate) {
        ...
        try {
            ...
            log.info("调整账户积分记录，发送MQ消息完成 userId: {} orderId:{} queue: {}", userId, creditOrderEntity.getOrderId(), task.getQueue());
        } catch (Exception e) {
            log.error("调整账户积分记录，发送MQ消息失败 userId: {} queue: {}", userId, task.getQueue());
