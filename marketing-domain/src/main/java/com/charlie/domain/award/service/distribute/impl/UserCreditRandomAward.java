package com.charlie.domain.award.service.distribute.impl;
...
public class UserCreditRandomAward implements IDistributeAward {
    ...
    public void giveOutPrizes(DistributeAwardEntity distributeAwardEntity) {
        ...
        // 构建聚合对象
        UserAwardRecordEntity userAwardRecordEntity = GiveOutPrizesAggregate.buildDistributeUserAwardRecordEntity(distributeAwardEntity.getUserId(),
                distributeAwardEntity.getOrderId(), distributeAwardEntity.getAwardId(), AwardStateVO.complete);
